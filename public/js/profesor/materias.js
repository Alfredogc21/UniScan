document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBaseUrl() {
        return window.location.href.split('/profesor/')[0];
    }
    ...
    function openViewModal(materiaId) {
        ...
        .then(data => {
            // Llenar los datos en el modal de visualización
    ...
    function generateQR(materiaId) {
        const baseUrl = getBaseUrl();
        fetch(`${baseUrl}/profesor/materias/${materiaId}/generate-qr`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
